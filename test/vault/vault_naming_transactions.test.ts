...
describe("Vault Naming Transactions", () => {
    ...
    it("UpdateVault naming", async function () {
        ...
        let expectedTrs: VaultUpdateNamingTransaction = buildExpectedNamingTransaction(tr, TransactionState.Executed)
    ...
    function buildExpectedNamingTransaction(actualTr, state) {
